...
public class CateoDeDatos {
	 ...
	 * detras de un casteo, es optimizar el uso de recursos, para la presentaci�n de
	 ...
	 * -> 64 bits // Representaci�n de un decimal
	 * 
	...
	public static void main(String[] args) {
		...
		System.out.println((double) ent1);// Si se castea si cambiar�
		 ...
		 * el resultado en base de esta configuaraci�n. resultadoEntero = (float)ent1 /
