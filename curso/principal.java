...
public class principal {
    public static void main(String[] args) {
        /** 
         * ------- PERRO----------
        //aqui debemos crear el perro, asignamos un nombre al objeto, creamos un "perro"
        //ya que creamos nuevo objeto perro necesitamos llevar todas las cosas que creamos en el constructor
        ...
        //clase objeto_crear = crar objeto(new) donde pertenece (valores para crear el objet)
